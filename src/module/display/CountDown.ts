...
let displayMain: CountDown = null;
export class CountDown extends FormApplication {
  ...
  static showTimer() {
    if (displayMain) displayMain.render(true);
  }

  static startTimer(duration?: DTMod, forceRealtime : boolean = false) {
    ...
    else displayMain.resetTimer(duration);
