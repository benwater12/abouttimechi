...
add(increment: DTMod) {
   ...
   */
  toSeconds() : number { // come back to this
    let seconds: number = 
      Object.keys(DTMod.mapper).reduce((acc, key) => acc = acc + DTMod.mapper[key](this[key]), 0);
